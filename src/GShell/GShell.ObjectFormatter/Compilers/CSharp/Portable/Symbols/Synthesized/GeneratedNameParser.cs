...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal static class GeneratedNameParser
    {
        ...
        internal static bool TryParsePrimaryConstructorParameterFieldName(string fieldName, out string? parameterName)
        {
        ...
        /// </remarks>
        internal static bool TryParseFileTypeName(string generatedName, out string? displayFileName, out byte[]? checksum, out string? originalTypeName)
        {
